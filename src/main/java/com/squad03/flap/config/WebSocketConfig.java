...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        registry.enableSimpleBroker("/topic", "/queue");  // ✅ Adiciona "/" no queue
        registry.setApplicationDestinationPrefixes("/app");
        registry.setUserDestinationPrefix("/user");
    }

    // ✅ NOVO: Interceptor para autenticar conexões WebSocket com Basic Auth
    @Override
        ...
        registration.interceptors(new ChannelInterceptor() {
            ...
            public Message<?> preSend(Message<?> message, MessageChannel channel) {
                ...
                if (accessor != null && StompCommand.CONNECT.equals(accessor.getCommand())) {
                    ...
                    System.out.println("🔐 Tentando autenticar WebSocket...");
                    ...
                    if (authHeader != null && authHeader.startsWith("Basic ")) {
                        try {
                            ...
                            if (values.length == 2) {
                                String username = values[0];  // email
                                ...
                                System.out.println("✅ WebSocket autenticado com sucesso: " + username);
                            }
                        } catch (Exception e) {
                        ...
                        System.err.println("⚠️ Authorization header não encontrado ou inválido");
                    }
                }
